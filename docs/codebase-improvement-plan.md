...
| 5.11 | Trade follow-up: new modals off-style | `TradeProgressModal.tsx`, `TradeCompletedNotification.tsx` | 🤝/✓ iconography + cool slate palette remain after the Phase 4 HUD commit. This is now explicitly tracked in `graphics-overhaul-plan.md` Phase 4.5 alongside the full modal/resource retirement pass. |
