...
async function fixFFOEProgressDecks() {
    ...
    console.log('🔗 Connection string:', process.env.SUPABASE_DATABASE_URL ? 'SUPABASE_DATABASE_URL is set' : 'SUPABASE_DATABASE_URL not set');
    console.log('🔗 DATABASE_URL:', process.env.DATABASE_URL ? 'DATABASE_URL is set' : 'DATABASE_URL not set');
